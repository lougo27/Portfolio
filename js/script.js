...
let photoProjet = [
    { nom: 'coquillage', src: 'GameMuseum.png', titre: 'projet secret', description : 'blabalabajanajz', conclusion : 'bye-bye', image1 : 'GameMuseum.png', image2 : 'GameMuseum2.png', image3 : 'GameMuseum3.png'},
    { nom: 'eau', src: 'galeriePhotos2.png', titre : "l'eau c'est la vie", description : "mais après tout l'alcool c'est de l'eau sauf que l'alcool tue", conclusion : 'on va tous mourrir', image1 : 'galeriePhotos.png', image2 : 'galeriePhotos2.png', image3 : 'galeriePhotos3.png'},
    { nom: 'canape', src: 'Montre_LouaneGouin-100.jpg', titre : 'Illustration de montre', description : "faudrait installer un lit dans la classe", conclusion : "Je rêve d'une petite sieste", image1 : 'montre_modele.png', image2 : 'Montre_LouaneGouin-100.jpg' , image3 : 'Montre_LouaneGouin2.jpg', },
    ...
    { nom: 'hibou', src: 'bubble.png', image1 : 'bubble.png', image2 : "anim_bubble.png", image3 : 'mockup_bubble.jpg' },
    { nom: 'photo', src: 'LogoLigne.png', image1 : 'LogoLigne.png', image2 : 'teeShirtNoirDos.png', image3 : 'naviguation site.mp4' },
    { nom: 'photo1', src: 'doctolib.png', image1 : 'logo_doctolib.png', image2 : 'doctolib.png', image3 : 'Phase_explo_projet_perso.pdf' },
    { 
      nom: 'trousse',
      src: 'trousse.jpg',
      medias: [
...
for (let i = 0; i < photoProjet.length; i++) {
    ...
    photos.src = `assets/images/projets/${photoProjet[i].src}`
    photos.alt = photoProjet[i].nom

    divPhotos.style.backgroundImage = `url("assets/images/projets/${photoProjet[i].src}")`
